...
build() {
  ...
  cd "$srcdir/$pkgname/Exodia-store" # هذا هو التعديل
...
package() {
  ...
  cd "$srcdir/$pkgname/Exodia-store" # هذا هو التعديل أيضًا
